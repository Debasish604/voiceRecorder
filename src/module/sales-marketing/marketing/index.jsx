...
const MarketingModule = () => {
  ...
  const inventoryData = [
    ...
    { MATKL_Material_Category: 'Category 5', InventoryTurnover: 35 },
  ];
  ...
  return (
    <Box m="20px">
      ...
      <Grid container spacing={2} marginTop={2}>
        <Grid  item xs={4}  md={3} marginRight={2}>
          <Box
            gridColumn="span 3"
      ...
      <Grid container spacing={2} marginTop={2}>
        ...
        <Grid item xs={6} md={6}>
          <label>Ad Reach</label>
          <DistributedColumnChart
            labels={MATKL_Material_Category}
            series={InventoryTurnover}
            height='320'
            legend='Ad Reach Score (%)'
